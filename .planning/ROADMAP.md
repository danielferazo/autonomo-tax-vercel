...
|---|-------|------|--------------|------------------|
| 1 | Foundation | Set up Vite + React project with Supabase auth and schema | AUTH-01, AUTH-02, FILE-01, PROF-01, PROF-02 | User can sign up/login; Profile persists; File upload works |
...
| 3 | Modelo 303 & 130 | Tax form calculations wired to live data | M303-01, M303-02, M303-03, M303-04, M303-05, M130-01, M130-02, M130-03, M130-04 | All casillas calculate correctly; Prior data offsets correctly |
